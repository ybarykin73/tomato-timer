    ...
    return (
        <div className="circle">
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 120 120" >  
                ...
                <circle cx="60" cy="60" r="50" transform="rotate(-90 60 60)" fill="none" strokeDashoffset={Math.floor(strokeDasharray * strokeDashoffse/timeLimi)} strokeDasharray={strokeDasharray} stroke="dodgerblue" strokeWidth="8" ></circle>
            </svg>  
        </div>
    )
}
